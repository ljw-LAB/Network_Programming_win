...
unsigned WINAPI ClntConnect(void* arg);
...
void SendData(SOCKET sock, char* ct, char* filename)
{
    char protocol[] = "HTTP/1.0 200 Bad Request \r\n";
...
void SendErrorMSG(SOCKET sock)
{
    ...
    char content[] = "<html><head><title>NEWWORK</title></head""<body><font size+=5><br>오류 발생! 요청 파일명 및 요청 방식 확인!""</font></body></html>";
